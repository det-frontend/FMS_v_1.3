...
// create a component
const RealTimeCounting = ({ handleErrorCon, printFormInfo, setSaleLiter, setSalePrice, nozzle1FuelDetail,setRealTimeEdit,handleRealTimeUpdate,realTimeEditChooseOne,setPrintFormInfo,obj,fetchObj }) => {
  ...
  useEffect(() => {
    ...
    return (
         <View style={{ marginTop: 15 }}>
              <RealTime   printFormInfo={printFormInfo} setSaleLiter={setSaleLiter} setSalePrice={setSalePrice} obj={nozzle1FuelDetail} />
              <View style={{
              marginTop:10
            }}>
        </View>
             ...
             <AppText color='white' fontWeight={'200'} fontSize={12}>Vocono</AppText>
              <AppTextInput editable={false}  value={printFormInfo.vocono} placeholder="Vocono Number" icon={'paperclip'} />
          </View>
           <View style={{
                  width:'45%'
              }}>
              <AppText color='white' fontWeight={'200'} fontSize={12}>Car No</AppText>
              <AppTextInput  onChangeText={newText => setCarNo(newText)} width={100} editable={true}  value={carNo} placeholder="Car No" icon={'car'} />
              </View>
           ...
           <View style={{
            ...
            <AppText color='white' fontWeight={'200'} fontSize={12}>Cash Type</AppText>
            <CashTypePicker icon={'cash'} placeholder={'Cash Type'} selectedItem={cashType} onSelectedItem={(item)=>setCashType(item.method)}/>
            </View>
             
                <View style={{
                 width:'45%'
               }}>
            <AppText color='white' fontWeight={'200'} fontSize={12}>Purpose of Use</AppText>
            <PurposeOfUsePicker
            ...
            <AppTextInput width={100} editable={false}  value={customer.cou_id === null?"00000":customer.cou_id} placeholder="Customer Id" icon={'id-card'} />
            </View>
        </View>
         {
          realTimeEditChooseOne &&  <View style={{
                                marginTop: 5,
                                marginBottom:5,
                                borderRadius: 5,
                                padding:3,
          ...
          <Button title={"Update"} width={50} color={color.activeColor} onPress={handleRealTimeUpdate}></Button>
         </View>
           <TouchableWithoutFeedback onPress={handleErrorCon}><MaterialCommunityIcons name='shield-alert' size={40} color={'#f39c12'}/></TouchableWithoutFeedback>  
                </View> 
              </View>
    );
};
