...
function TankPicker({ icon,items,label,value,placeholder,selectedItem,onSelectedItem, ...otherProps }) {
             ...
             {icon && <MaterialCommunityIcons
              ...
              style={styles.icon}
                  />}
                    {
                        selectedItem ?
                            (<AppText style={{ flex: 1 }} styles={styles.text}>Tank No - {selectedItem[label]}</AppText>):
